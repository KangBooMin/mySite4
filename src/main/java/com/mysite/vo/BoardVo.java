...
public class BoardVo {
	...
	public BoardVo(String title, String content, int hit, String date, int userNo) {
		super();
		this.title = title;
	...
	public BoardVo(String title, String content, int hit, String date, int userNo, String name) {
		super();
		this.title = title;
		this.content = content;
		this.hit = hit;
